...
To do: 
[x] Create movie card
[x] Import, make sure it works
[x] Write props
[x] Keep breathing because you'll figure it out
[x] Rework props again
[x] Take a break
[x] Fix props problems
[x] Feel really proud of yourself
...
to do: 
[ ] pass `addToSavedList` function to `Movie` component
[ ] event handler
